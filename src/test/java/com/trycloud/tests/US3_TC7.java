...
public class US3_TC7 extends TestBase {
    ...
    public void test_UploadingAFile(){
       ...
       //this is a table, so this should be correct xpath. Try with team again(1/2)
        driver.findElement(By.xpath("//table[@class='list-container  has-controls']//tr[2]//td[2]")).click();
...
//        //Test case #7 - verify users can upload a file inside a folder
    ...
    public void test_writingAComment() {
        ...
        driver.findElement(By.xpath("(//a[@class='action action-menu permanent'])[2]")).click();
        //3. Click details
        BrowserUtils.sleep(2);
        driver.findElement(By.xpath("//span[.='Details']")).click();
        //Locatin a comment sign
        BrowserUtils.sleep(2);
        driver.findElement(By.xpath("//a[@id='commentsTabView']")).click();
        //4. Write a comment inside to the input box
        WebElement commentBox = driver.findElement(By.xpath("(//div[@contenteditable='true'])[2]"));
        commentBox.clear();
        commentBox.sendKeys("Excellent job!");
        //5. Click the submit button to post it
        BrowserUtils.sleep(2);
        driver.findElement(By.xpath("//input[@class='submit icon-confirm has-tooltip']")).click();
